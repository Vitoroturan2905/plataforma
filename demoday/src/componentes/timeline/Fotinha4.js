...
import "./Styles.css";
import Video4 from './imagens/4.mp4'

function Fotinha4(props){
    return(
        <div className="fotinha" >
           <div className="foto_nome">
            ...
            <h4 className="nome_fotinha">CrisNails </h4> 
            
            </div>
        
            <div className="img_timeline">
            <div className="App">
            <video className='video' src={Video4} controls loop />
      </div>
            </div>
