...
import "./Styles.css";
import Video6 from './imagens/6.mp4'

function Fotinha6(props){
    return(
        <div className="fotinha" >
           <div className="foto_nome">
            ...
            <h4 className="nome_fotinha"> FABIunhas </h4> 
            
            </div>
        
            <div className="img_timeline">
            <div className="App">
            <video className='video' src={Video6} controls loop />
      </div>
            </div>
